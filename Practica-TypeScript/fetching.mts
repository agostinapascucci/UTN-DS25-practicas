...
export class Convert {
    public static toGitHubAPI(json: string): GitHubAPI {
        return cast(JSON.parse(json), r("GitHubAPI"));
    }

    public static gitHubAPIToJson(value: GitHubAPI): string {
        return JSON.stringify(uncast(value, r("GitHubAPI")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Owner": o([
        ...
        { json: "user_view_type", js: "user_view_type", typ: r("Visibility") },
